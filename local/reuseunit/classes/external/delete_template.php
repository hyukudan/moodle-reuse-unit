...
/**
 * External function to delete a template.
 *
...
class delete_template extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'templateid' => new external_value(PARAM_INT, 'Template ID to delete'),
        ]);
    }
    ...
    public static function execute(int $templateid): array {
        ...
        // Check permission.
        $candelete = ($template->userid == $USER->id) || has_capability('local/reuseunit:managetemplates', $context);
        ...
        return [
            'success' => true,
            'message' => get_string('templatedeleted', 'local_reuseunit'),
        ];
    }
